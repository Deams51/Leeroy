 ...
 */
class GprModellistevps extends JModelList
{
	...
	public function accept($pks)
	{
		...
		foreach($pks as $id)
		{
			...
			$query_add
				...
				->values(implode(',',array('null',"'vps_create'",$id,time())));
	...
	public function delete($pks)
	{
		...
		foreach($pks as $id)
		{
			...
			$query_add
				->insert($db->quoteName('#__gpr_updates'))
				->columns($db->quoteName(array('id','action','id_service','arg')))
				->values(implode(',',array('null',"'vps_delete'",$id,time())));
