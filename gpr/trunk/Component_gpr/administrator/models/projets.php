 ...
 */
class GprModelprojets extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		// Join over the user field 'id'
		//$query->select('id.name AS id');
		$query->join('LEFT', '#__gpr_membres ON a.id = #__gpr_membres.ID_projet AND #__gpr_membres.statut = 1');
